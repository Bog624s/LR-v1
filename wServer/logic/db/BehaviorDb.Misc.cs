    ...
    partial class BehaviorDb
    {
        private static _ Misc = Behav()
                ...
                new State("WildWildWest",
                    new QueuedBehavior(
                        ...
                        Cooldown.Instance(450,
                            MultiAttack.Instance(12, 10*(float) Math.PI/180, 5, 6f, projectileIndex: 0)),
                        Flashing.Instance(10000, 0xFF000000),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 0*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 18*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 36*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 54*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 72*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 90*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 108*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 126*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 144*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 162*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 180*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 198*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 216*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 234*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 252*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 270*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 288*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 306*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 324*(float) Math.PI/180, projectileIndex: 0))),
                        Cooldown.Instance(250,
                            new RunBehaviors(RingAttack.Instance(3, offset: 342*(float) Math.PI/180, projectileIndex: 0)))
                        )
                    ),
                Cooldown.Instance(1000,
                    Rand.Instance(
            ...
            .Init(0x195c, Behaves("Mega Sheep Minion",
                ...
                {
                    new ChatEvent(
                        new SimpleTaunt("I dont know who you are \n But I will find you \n And I will kill you"))
                        .SetChats(new[] {"baa baa baa"})
                }
                ))
            .Init(0x1964, Behaves("Phoenix Wright",
                new RunBehaviors(
                    Chasing.Instance(6.5f, 30, 1.5f, null),
                    CooldownExact.Instance(800, MultiAttack.Instance(10, 10*(float) Math.PI/180, 5)),
                    CooldownExact.Instance(4000, PlaySound.Instance()),
                    Cooldown.Instance(1000, HealGroup.Instance(30, 800, "Gods"))
                    )
                ))
            .Init(0x701e, Behaves("Ghost Sheep",
                Once.Instance(SetConditionEffect.Instance(ConditionEffectIndex.Invisible)),
                new QueuedBehavior(
                    RandomDelay.Instance(2500, 7500),
                    SimpleWandering.Instance(2, 2)
                    ),
                Cooldown.Instance(1000,
                    Rand.Instance(
                        new RandomTaunt(0.001, "baAaAAaa"),
                        new RandomTaunt(0.001, "baAaaA baAaaAa")
                        )
                    )
                ));
    }
