...
namespace wServer.logic
{
    ...
    {
        private static _ UndeadLair = Behav()
            .Init(0x0d90, Behaves("Septavius the Ghost God",
                Once.Instance(SpawnMinionImmediate.Instance(0x1730, 0, 1, 1)),
                If.Instance(IsEntityPresent.Instance(22, null),
                    new RunBehaviors(
                        new RunBehaviors(
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 2, 0, 8,
                            Tuple.Create(0.85, (ILoot)new ItemLoot("Potion of Wisdom")),
                            Tuple.Create(0.15, (ILoot)new ItemLoot("Potion of Speed"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(blackbag, (ILoot)new ItemLoot("Doom Bow of Evil")),
                            Tuple.Create(whitebag / 2, (ILoot)new ItemLoot("Bow of the Morning Star")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Doom Bow"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 2,
                            Tuple.Create(0.11, (ILoot)new ItemLoot("Small Dark Blue Stripe Cloth")),
                            Tuple.Create(0.08, (ILoot)new ItemLoot("Large Dark Blue Stripe Cloth"))
                    )),
                    Tuple.Create(100, new LootDef(0, 1, 0, 2,
                        Tuple.Create(blackbag, (ILoot)new ItemLoot("Wine Cellar Incantation")),
                        Tuple.Create(whitebag, (ILoot) new ItemLoot("Void Incantation"))
                        ))
                    )
                ))
            ...
            .Init(0x1730, Behaves("Septavius Summoner",
                new QueuedBehavior(
                    SetConditionEffect.Instance(ConditionEffectIndex.Invincible),
                    Cooldown.Instance(2000),
                    new SetKey(-1, 1)),
                IfEqual.Instance(-1, 1,
                    If.Instance(IsEntityNotPresent.Instance(100, 0x0d90), Die.Instance)
                    ),
                condBehaviors: new ConditionalBehavior[]
                {
