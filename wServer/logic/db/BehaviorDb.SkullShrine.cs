                ...
                IfNot.Instance(
                    ...
                    Cooldown.Instance(5000,
                        ...
                        Tuple.Create(100, new LootDef(0, 3, 0, 8,
                            Tuple.Create(blackbag, (ILoot)new ItemLoot("Cracked Elder Orb of Conflict")),
                            Tuple.Create(whitebag, (ILoot) new ItemLoot("Orb of Conflict")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Skull's Fire")),
                            Tuple.Create(0.11, (ILoot)new ItemLoot("Small Yellow Dot Cloth")),
                            Tuple.Create(0.08, (ILoot)new ItemLoot("Large Yellow Dot Cloth")),
                            Tuple.Create(0.05, (ILoot) new TierLoot(11, ItemType.Weapon)),
                            Tuple.Create(0.15, (ILoot) new TierLoot(11, ItemType.Armor)),
                            Tuple.Create(0.15, (ILoot) new TierLoot(5, ItemType.Ring)),
                            Tuple.Create(0.25, (ILoot) new TierLoot(10, ItemType.Weapon)),
                            Tuple.Create(0.25, (ILoot) new TierLoot(10, ItemType.Armor)),
                            Tuple.Create(0.35, (ILoot) new TierLoot(9, ItemType.Weapon)),
                            Tuple.Create(0.35, (ILoot) new TierLoot(5, ItemType.Ability)),
                            Tuple.Create(0.35, (ILoot) new TierLoot(9, ItemType.Armor)),
                            //Tuple.Create(0.05, (ILoot)new StatPotionsLoot(1, 2)),
                            Tuple.Create(0.55, (ILoot) new TierLoot(4, ItemType.Ring)),
                            Tuple.Create(0.65, (ILoot) new TierLoot(4, ItemType.Ability)),
                            Tuple.Create(0.65, (ILoot) new TierLoot(8, ItemType.Armor)),
                            Tuple.Create(0.85, (ILoot) new TierLoot(8, ItemType.Weapon)),
                            Tuple.Create(0.85, (ILoot) new TierLoot(7, ItemType.Armor)),
                            Tuple.Create(0.85, (ILoot) new TierLoot(3, ItemType.Ring))
                            )),
