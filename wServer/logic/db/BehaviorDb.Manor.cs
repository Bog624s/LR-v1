    ...
    partial class BehaviorDb
    {
        private static _ Manor = Behav()
            .Init(0x1720, Behaves("Lord Ruthven",
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 2, 0, 2,
                        Tuple.Create(WBChance, (ILoot) new ItemLoot("Tome of Purification")),
                        Tuple.Create(WBChance*10, (ILoot) new ItemLoot("St. Abraham's Wand")),
                        Tuple.Create(WBChance*5, (ILoot) new ItemLoot("Chasuble of Holy Light")),
                        Tuple.Create(0.01, (ILoot) new ItemLoot("Void Incantation")),
                        ...
                        Tuple.Create(WBChance*15, (ILoot) new ItemLoot("Ring of Divine Faith")),
            ...
            .Init(0x1721, Behaves("Vampire Bat",
                new RunBehaviors(
                    Cooldown.Instance(5000, If.Instance(IsEntityPresent.Instance(20, null),
                        Chasing.Instance(8, 20, 2, null)
                        )),
                    IfNot.Instance(Chasing.Instance(8, 20, 2, null),
                        SimpleWandering.Instance(2, 1)
            ...
            .Init(0x1737, Behaves("Coffin",
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(awesomeloot, (ILoot)new ItemLoot("Bone Dagger"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(blackbag, (ILoot)new ItemLoot("Ancient Tome of Divine Purification")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Tome of Purification"))
                    )),
                        Tuple.Create(100, new LootDef(0, 2, 0, 8,
                            Tuple.Create(goodloot, (ILoot)new ItemLoot("Chasuble of Holy Light")),
                            Tuple.Create(goodloot, (ILoot)new ItemLoot("Ring of Divine Faith")),
                            Tuple.Create(goodloot, (ILoot)new ItemLoot("St. Abraham's Wand"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.65, (ILoot)new ItemLoot("Potion of Attack"))
                    ))
                    )
                ));
    }
