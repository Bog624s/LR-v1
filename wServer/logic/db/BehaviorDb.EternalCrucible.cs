...
namespace wServer.logic
{
  ...
  {
    static _ EternalCrucible = Behav()
            .Init(0x70a5, Behaves("The Crucible One Chest",
                new RunBehaviors(
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(awesomeloot, (ILoot)new ItemLoot("Potion of the Inferno"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(goodloot, (ILoot)new TierLoot(10, ItemType.Weapon)),
                            Tuple.Create(normalloot, (ILoot)new TierLoot(9, ItemType.Weapon)),
                            Tuple.Create(normalloot, (ILoot)new TierLoot(8, ItemType.Weapon))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
            ...
            .Init(0x70a6, Behaves("The Crucible Two Chest",
                new RunBehaviors(
                    IfExist.Instance(-1, NullBehavior.Instance,
                        new RunBehaviors(
                            new QueuedBehavior(
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(awesomeloot, (ILoot)new ItemLoot("Potion of the Immortals"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(goodloot, (ILoot)new TierLoot(10, ItemType.Weapon)),
                            Tuple.Create(normalloot, (ILoot)new TierLoot(9, ItemType.Weapon)),
            ...
            .Init(0x70a7, Behaves("The Crucible Boss Chest",
                new RunBehaviors(
                    IfExist.Instance(-1, NullBehavior.Instance,
                        new RunBehaviors(
                            new QueuedBehavior(
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                             Tuple.Create(whitebag, (ILoot)new ItemLoot("Phoenix Hide Armor")),
                             Tuple.Create(whitebag, (ILoot)new ItemLoot("Robe of the Fire Bird")),
                             Tuple.Create(whitebag, (ILoot)new ItemLoot("Armor of Everlasting Life"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Sentient Staff")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Ancient Spell: Pierce")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("The Robe of Twilight")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("The Forgotten Ring"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.11, (ILoot)new ItemLoot("Small Blue Fireworks Cloth")),
                            Tuple.Create(0.08, (ILoot)new ItemLoot("Large Blue Fireworks Cloth"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.55, (ILoot)new StatPotionsLoot(1, 2))
                    ))
             ...
             new RunBehaviors(
               ...
               IfEqual.Instance(-1, 3,
                 new RunBehaviors(
                   ...
                   new QueuedBehavior(
                     ...
                     MultiAttack.Instance(30, 25 * (float)Math.PI / 360, 2, 0, projectileIndex: 1),
                     MultiAttack.Instance(30, 10 * (float)Math.PI / 360, 3, 180 * (float)Math.PI / 180, projectileIndex: 1),
                     CooldownExact.Instance(800),
                     new SetKey(-1, 1)
                   )
                 )
               ...
               IfEqual.Instance(-1, 5,
                 new RunBehaviors(
                   ...
                   Cooldown.Instance(999, SimpleAttack.Instance(20, projectileIndex: 1)),
                   new QueuedBehavior(
               ...
               IfEqual.Instance(-1, 6,
                 new RunBehaviors(
                   ...
                   new QueuedBehavior(
                     CooldownExact.Instance(800),
                     MultiAttack.Instance(25, 15 * (float)Math.PI / 360, 4, 180 * (float)Math.PI / 180, projectileIndex: 1),
                     MultiAttack.Instance(20, 10 * (float)Math.PI / 360, 3, 0, projectileIndex: 2),
                     MultiAttack.Instance(20, 10 * (float)Math.PI / 360, 3, 0, projectileIndex: 3),
                     MultiAttack.Instance(20, 10 * (float)Math.PI / 360, 3, 0, projectileIndex: 4),
                     MultiAttack.Instance(20, 10 * (float)Math.PI / 360, 3, 0, projectileIndex: 5),
                     MultiAttack.Instance(20, 10 * (float)Math.PI / 360, 3, 0, projectileIndex: 6),
                     MultiAttack.Instance(20, 10 * (float)Math.PI / 360, 3, 0, projectileIndex: 7),
                     MultiAttack.Instance(20, 10 * (float)Math.PI / 360, 3, 0, projectileIndex: 8),
                     CooldownExact.Instance(800),
                     new SetKey(-1, 1)
                   )
                 )
      ...
      //End of Phase 3
               ...
               IfEqual.Instance(-1, 8,
                 new RunBehaviors(
                   ...
                   Cooldown.Instance(1500, MultiAttack.Instance(40, 15 * (float)Math.PI / 360, 2, 0, projectileIndex: 4)),
      ...
      //End of Phase 5
               ...
               IfEqual.Instance(-1, 10,
                 new RunBehaviors(
                   new QueuedBehavior(
                     RingAttack.Instance(10, 0, 0, projectileIndex: 4),
                     new SetKey(-1, 11)
                   )
                 )
               ),
               ...
               IfBetween.Instance(-1, 10, 16,
                 new RunBehaviors(
                   InfiniteSpiralAttack.Instance(275, 4, 15, projectileIndex: 3),
                   Cooldown.Instance(750, MultiAttack.Instance(25, 16 * (float)Math.PI / 360, 4, 0, projectileIndex: 2)),
                   Cooldown.Instance(1000, RingAttack.Instance(10, 0, 0, projectileIndex: 4)),
      ...
      //End of Phase 6
               ...
               IfEqual.Instance(-1, 17,
                 new RunBehaviors(
                   ...
                   Cooldown.Instance(900, RingAttack.Instance(10, 0, 0, projectileIndex: 4)),
                   Cooldown.Instance(15000, RingAttack.Instance(20, 0, 0, projectileIndex: 1)),
                   InfiniteSpiralAttack.Instance(200, 4, 5, projectileIndex: 3),
                   new QueuedBehavior(
      ...
      //End of Phase 7
          ...
          condBehaviors: new ConditionalBehavior[]
                  ...
                  new OnDeath(
                    new RunBehaviors(
                      ...
                      Once.Instance(new RandomDo(100, SpawnMinionImmediate.Instance(0x70a5, 1, 1, 1)))
                    )
                  )
        	      }
          ))
             ...
             new RunBehaviors(
               ...
               IfEqual.Instance(-1, 2,
                 new RunBehaviors(
                   ...
                   Cooldown.Instance(3000, If.Instance(EntityLesserThan.Instance(80, 2, 0x2f77), SpawnMinionImmediate.Instance(0x2f77, 1, 1, 1)))
                 )
               ),
          ...
          .Init(0x2f77, Behaves("Lava Creature",
             new RunBehaviors(
               ...
               Cooldown.Instance(1250, RingAttack.Instance(5, 0, 0, projectileIndex: 1)),
          ...
          .Init(0x2f79, Behaves("Scorching Voice",
             new RunBehaviors(
               new QueuedBehavior(
                 new QuietTaunt("You have proven your determination. I have allowed access across the volcano by removing the lava. Go now, and don't come back."),
                 Despawn.Instance
               )
             )
          ))
          ...
          .Init(0x2f7b, Behaves("Eternal Crucible Monolith",
             new RunBehaviors(
               ...
               IfEqual.Instance(-1, 1,
                 new RunBehaviors(
                   SetConditionEffect.Instance(ConditionEffectIndex.Invincible),
                   If.Instance(IsEntityPresent.Instance(35, null), Once.Instance(new SimpleTaunt("Come, adventurer. This crucible will end with your encounter with me."))),
      ...
      //End of Phase 0
               ...
               IfEqual.Instance(-1, 4,
                 new RunBehaviors(
                   Cooldown.Instance(1000, MultiAttack.Instance(30, 25 * (float)Math.PI / 360, 14, 0, projectileIndex: 1)),
      ...
      //End of Phase 1
               ...
               IfEqual.Instance(-1, 5,
                 new RunBehaviors(
                   UnsetConditionEffect.Instance(ConditionEffectIndex.Invincible),
                   InfiniteSpiralAttack.Instance(300, 5, 25, projectileIndex: 2),
                   Cooldown.Instance(400, MultiAttack.Instance(30, 23 * (float)Math.PI / 360, 3, 0, projectileIndex: 1)),
      ...
      //End of Phase 2
               ...
               IfEqual.Instance(-1, 6,
                 new RunBehaviors(
                   InfiniteSpiralAttack.Instance(250, 5, 30, projectileIndex: 2),
      ...
      //End of Phase 3
               ...
               IfEqual.Instance(-1, 7,
                 new RunBehaviors(
                   Cooldown.Instance(350, RingAttack.Instance(4, 0, 0, projectileIndex: 2)),
                   Cooldown.Instance(550, MultiAttack.Instance(30, 20 * (float)Math.PI / 360, 4, 0, projectileIndex: 1)),
                   Cooldown.Instance(400, MultiAttack.Instance(30, 12 * (float)Math.PI / 360, 5, 0, projectileIndex: 3)),
                   Cooldown.Instance(450, MultiAttack.Instance(30, 17 * (float)Math.PI / 360, 4, 0, projectileIndex: 4)),
      ...
      //End of Phase 4
               ...
               IfEqual.Instance(-1, 8,
                 new RunBehaviors(
                   new QueuedBehavior(
                     RingAttack.Instance(6, 0, 150 * (float)Math.PI / 180, projectileIndex: 2),
                     CooldownExact.Instance(200),
                     RingAttack.Instance(6, 0, 125 * (float)Math.PI / 180, projectileIndex: 2),
                     CooldownExact.Instance(200),
                     RingAttack.Instance(6, 0, 100 * (float)Math.PI / 180, projectileIndex: 2),
                     CooldownExact.Instance(200),
                     RingAttack.Instance(6, 0, 75 * (float)Math.PI / 180, projectileIndex: 2),
                     CooldownExact.Instance(200),
                     RingAttack.Instance(6, 0, 25 * (float)Math.PI / 180, projectileIndex: 2),
                     CooldownExact.Instance(200),
                     RingAttack.Instance(6, 0, 0 * (float)Math.PI / 180, projectileIndex: 2),
                     new SetKey(-1, 9)
                   )
                 )
               ),
               ...
               IfEqual.Instance(-1, 9,
                 new RunBehaviors(
                   InfiniteSpiralAttack.Instance(200, 6, 5, projectileIndex: 2),
                   new QueuedBehavior(
               ...
               IfEqual.Instance(-1, 10,
                 new RunBehaviors(
                   InfiniteSpiralAttack2.Instance(200, 6, 9, 25, projectileIndex: 2),
                   new QueuedBehavior(
                     CooldownExact.Instance(1001),
                     new SetKey(-1, 11)
                   )
               ...
               IfEqual.Instance(-1, 11,
                 new RunBehaviors(
                   InfiniteSpiralAttack2.Instance(200, 6, 15, 85, projectileIndex: 2),
                   new QueuedBehavior(
                     CooldownExact.Instance(1001),
                     new SetKey(-1, 12)
                   )
               ...
               IfEqual.Instance(-1, 12,
                 new RunBehaviors(
                   InfiniteSpiralAttack2.Instance(200, 6, 28, 200, projectileIndex: 2),
                   new QueuedBehavior(
                     CooldownExact.Instance(1001),
                     new SetKey(-1, 13)
                   )
               ...
               IfEqual.Instance(-1, 13,
                 new RunBehaviors(
                   InfiniteSpiralAttack2.Instance(200, 6, 41, 20, projectileIndex: 2),
                   new QueuedBehavior(
               ...
               IfEqual.Instance(-1, 14,
                 new RunBehaviors(
                   InfiniteSpiralAttack2.Instance(200, 6, 28, 155, projectileIndex: 2),
                   new QueuedBehavior(
                     CooldownExact.Instance(1001),
                     new SetKey(-1, 15)
                   )
               ...
               IfEqual.Instance(-1, 15,
                 new RunBehaviors(
                   InfiniteSpiralAttack2.Instance(200, 6, 15, 335, projectileIndex: 2),
                   new QueuedBehavior(
                     CooldownExact.Instance(1001),
                     new SetKey(-1, 16)
                   )
               ...
               IfEqual.Instance(-1, 16,
                 new RunBehaviors(
                   InfiniteSpiralAttack2.Instance(200, 6, 9, 90, projectileIndex: 2),
                   new QueuedBehavior(
                     CooldownExact.Instance(1001),
                     new SetKey(-1, 17)
                   )
               ...
               IfEqual.Instance(-1, 17,
                 new RunBehaviors(
                   InfiniteSpiralAttack2.Instance(200, 6, 5, 150, projectileIndex: 2),
                   new QueuedBehavior(
                     CooldownExact.Instance(1001),
                     new SetKey(-1, 8)
                   )
      ...
      //End of Phase 5
               ...
               IfEqual.Instance(-1, 18,
                 new RunBehaviors(
                   SetConditionEffect.Instance(ConditionEffectIndex.Invincible),
                   Flashing.Instance(75, 0xfffaf200),
                   Once.Instance(new SimpleTaunt("Life. Magic. Moral. What does this mean, to a being who has existed before time itself?")),
                   new QueuedBehavior(
               ...
               IfEqual.Instance(-1, 19,
                 new RunBehaviors(
                   ...
                   UnsetConditionEffect.Instance(ConditionEffectIndex.Invincible),
                   InfiniteSpiralAttack.Instance(200, 4, 25, projectileIndex: 1),
      ...
      //End of Final Phase
          condBehaviors: new ConditionalBehavior[]
                  ...
                  new OnDeath(
                    new RunBehaviors(
                      ...
                      Once.Instance(new RandomDo(100, SpawnMinionImmediate.Instance(0x70a6, 1, 1, 1)))
                    )
                  )
        	      }
          ))
          ...
          .Init(0x2f80, Behaves("Supreme Guardian",
             new RunBehaviors(
               ...
               InfiniteSpiralAttack2.Instance(850, 4, 45, 0, projectileIndex: 1)
             )
          ))
          ...
          .Init(0x2f82, Behaves("Eternal Voice",
             new RunBehaviors(
               new QueuedBehavior(
                 new QuietTaunt("You have proven that you have true skill and determination. The final crucible lies at the top of the mountain, where the true god lies."),
                 Despawn.Instance
               )
             )
          ))
          ...
          .Init(0x2fa0, Behaves("Phoenix God Shielded",
             new RunBehaviors(
               ...
               IfEqual.Instance(-1, 0,
                 new RunBehaviors(
                   SetConditionEffect.Instance(ConditionEffectIndex.Invincible),
                   If.Instance(IsEntityPresent.Instance(45, null), Once.Instance(new SimpleTaunt("It's you again! Though I shouldn't be surprised. I sensed a rogue, evil presence when you arrived."))),
                   If.Instance(IsEntityPresent.Instance(35, null), Once.Instance(new SimpleTaunt("I am not a god to be trifled with!"))),
                   If.Instance(IsEntityPresent.Instance(25, null), Once.Instance(new SimpleTaunt("Come and meet your demise!"))),
      ...
      //End of Phase One
               ...
               IfEqual.Instance(-1, 3,
                 new RunBehaviors(
                   ...
                   Cooldown.Instance(1100, MultiAttack.Instance(35, 20 * (float)Math.PI / 360, 12, 0, projectileIndex: 6)),
      ...
      //End of Phase Two
               ...
               IfEqual.Instance(-1, 5,
                 new RunBehaviors(
                   UnsetConditionEffect.Instance(ConditionEffectIndex.Invincible),
                   InfiniteSpiralAttack.Instance(200, 5, 7, projectileIndex: 4),
                   InfiniteSpiralAttack.Instance(250, 9, 15, projectileIndex: 2),
      ...
      //End of Phase Four
               ...
               IfEqual.Instance(-1, 9,
                 new RunBehaviors(
                   CooldownExact.Instance(300, RingAttack.Instance(8, 0, 0, projectileIndex: 3)),
                   new QueuedBehavior(
               ...
               IfEqual.Instance(-1, 10,
                 new RunBehaviors(
                   UnsetConditionEffect.Instance(ConditionEffectIndex.Invincible),
                   InfiniteSpiralAttack.Instance(300, 8, 8, projectileIndex: 3)
                 )
               )
             ),
             condBehaviors: new ConditionalBehavior[]
          ...
          .Init(0x2fa8, Behaves("Fiery Barrage",
            new RunBehaviors(
              ...
              MagicEye.Instance,
              RandomDelay2.Instance(250, 400, MultiAttack.Instance(35, 30 * (float)Math.PI / 360, 3, 0, projectileIndex: 0)),
              If.Instance(IsEntityNotPresent.Instance(100, 0x2fa0), new SetKey(-1, 1)),
              IfEqual.Instance(-1, 1,
                Despawn.Instance
              )
            ...
            new RunBehaviors(
              ...
              IfEqual.Instance(-1, 3,
                new RunBehaviors(
                  ...
                  InfiniteSpiralAttack.Instance(300, 3, 14, projectileIndex: 1),
                  InfiniteSpiralAttack2.Instance(300, 3, 14, 120, projectileIndex: 2),
                  Cooldown.Instance(10000, RingAttack.Instance(25, 0, 0, projectileIndex: 0)),
                  Cooldown.Instance(2500, RingAttack.Instance(12, 0, 0, projectileIndex: 3)),
                  Cooldown.Instance(1750, MultiAttack.Instance(35, 3 * (float)Math.PI / 360, 3, 0, projectileIndex: 4))
                )
              )
            ),
              ...
              IfEqual.Instance(-1, 1,
                new RunBehaviors(
                  ...
                  new QueuedBehavior(
                    ...
                    CooldownExact.Instance(3900),
                    new SimpleTaunt("It makes me laugh to think that such weaklings would pride themselves as gods..."),
                    CooldownExact.Instance(6900),
                    new SimpleTaunt("...and to think that you self-proclaimed heroes claim ownership to the Realm."),
      ...
      //End of Initial Phase
              ...
              IfEqual.Instance(-1, 2,
                new RunBehaviors(
                  ...
                  UnsetConditionEffect.Instance(ConditionEffectIndex.Invincible),
                  InfiniteSpiralAttack.Instance(200, 4, 10, projectileIndex: 1),
                  InfiniteSpiralAttack.Instance(200, 12, 7, projectileIndex: 2),
      ...
      //End of Phase Two
              ...
              IfEqual.Instance(-1, 7,
                new RunBehaviors(
                  ...
                  Cooldown.Instance(200, AngleMultiAttack.Instance(45 * (float)Math.PI / 180, 15 * (float)Math.PI / 360, 3, projectileIndex: 7)),
                  Cooldown.Instance(200, AngleMultiAttack.Instance(135 * (float)Math.PI / 180, 15 * (float)Math.PI / 360, 3, projectileIndex: 7)),
      ...
      //End of Phase Four
              ...
              IfBetween.Instance(-1, 12, 15,
                new RunBehaviors(
                  Cooldown.Instance(2300, RingAttack.Instance(8, 0, 0, projectileIndex: 8)),
      ...
      //End of Phase Five
              ...
              IfEqual.Instance(-1, 18,
                new RunBehaviors(
                  ...
                  CooldownExact.Instance(150, RingAttack.Instance(7, 0, 180 * (float)Math.PI / 180, projectileIndex: 9)),
                ...
                condBehaviors: new ConditionalBehavior[]
                    {
                        ...
                        new OnDeath(
                            Once.Instance(new RandomDo(100, SpawnMinionImmediate.Instance(0x70a7, 1, 1, 1))))
                    }
          ))
          ...
          .Init(0x2fad, Behaves("Phoenix God Tri-Shot",
            new RunBehaviors(
              ...
              RandomDelay2.Instance(400, 600, MultiAttack.Instance(35, 15 * (float)Math.PI / 360, 3, 0, projectileIndex: 0)),
          ...
          .Init(0x2faf, Behaves("Phoenix God Nuclear Orb",
            new RunBehaviors(
              ...
              RandomDelay2.Instance(500, 600, Rand.Instance(
                ...
                MultiAttack.Instance(25, 25 * (float)Math.PI / 360, 4, 0, projectileIndex: 1),
                MultiAttack.Instance(25, 25 * (float)Math.PI / 360, 3, 0, projectileIndex: 1),
                MultiAttack.Instance(25, 25 * (float)Math.PI / 360, 2, 0, projectileIndex: 1),
                MultiAttack.Instance(25, 25 * (float)Math.PI / 360, 1, 0, projectileIndex: 1),
                MultiAttack.Instance(25, 25 * (float)Math.PI / 360, 4, 0, projectileIndex: 2),
                MultiAttack.Instance(25, 25 * (float)Math.PI / 360, 3, 0, projectileIndex: 2),
                MultiAttack.Instance(25, 25 * (float)Math.PI / 360, 2, 0, projectileIndex: 2),
                MultiAttack.Instance(25, 25 * (float)Math.PI / 360, 1, 0, projectileIndex: 2)
                )),
          ...
          .Init(0x2fb1, Behaves("Phoenix God Fire Burst",
            new RunBehaviors(
              Once.Instance(SetConditionEffect.Instance(ConditionEffectIndex.Invincible)),
              If.Instance(IsEntityNotPresent.Instance(100, 0x2fab), new SetKey(-1, 1)),
              Cooldown.Instance(650, PredictiveMultiAttack.Instance(30, 20 * (float)Math.PI / 360, 9, 5, projectileIndex: 0)),
            ...
            new RunBehaviors(
              ...
              IfEqual.Instance(-1, 2,
                new RunBehaviors(
                  ...
                  InfiniteSpiralAttack.Instance(500, 5, 78, projectileIndex: 2),
                  Cooldown.Instance(300, SimpleAttack.Instance(30, projectileIndex: 1))
                )
              )
            )
          ))
