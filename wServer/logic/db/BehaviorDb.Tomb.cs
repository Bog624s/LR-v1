...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private static _ Tomb = Behav()
            .Init(0x0d28, Behaves("Tomb Defender",
                ...
                new RunBehaviors(
                    ...
                    new State("artifacts",
                        ...
                        Reproduce.Instance(0x0d24, 3, 3500, 4),
                        Reproduce.Instance(0x0d23, 3, 3500, 4),
                        Reproduce.Instance(0x0d22, 3, 3500, 4),
                    ...
                    new State("rage",
                        ...
                        //SpawnMinionImmediate.Instance(0x0d1b, 1, 5, 10),
                        Reproduce.Instance(0x0d1b, 3, 6000, 4)
                        )
                    ),
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.5, (ILoot)new ItemLoot("Potion of Life"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(blackbag, (ILoot)new ItemLoot("Ancient Tome of Holy Protection")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Tome of Holy Protection"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Ring of the Pyramid"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
            ...
            .Init(0x0d22,
                Behaves("Pyramid Artifact 1", Circling.Instance(3, 3, 10, 0x0d26),
                    Cooldown.Instance(5000, MultiAttack.Instance(120, 120*(float) Math.PI/180, 3, 0, projectileIndex: 0))
                    ))
            .Init(0x0d23,
                Behaves("Pyramid Artifact 2", Circling.Instance(3, 3, 10, 0x0d27),
                    Cooldown.Instance(5000, MultiAttack.Instance(120, 120*(float) Math.PI/180, 3, 0, projectileIndex: 0))
                    ))
            .Init(0x0d24,
                Behaves("Pyramid Artifact 3", Circling.Instance(3, 3, 10, 0x0d28),
                    Cooldown.Instance(5000, MultiAttack.Instance(120, 120*(float) Math.PI/180, 3, 0, projectileIndex: 0))
                    ))
            .Init(0x0d3f, Behaves("Bes Statue",
                SetConditionEffect.Instance(ConditionEffectIndex.Invulnerable),
                If.Instance(
                    IsEntityNotPresent.Instance(50000, 0x0d29),
                    IsEntityNotPresent.Instance(50000, 0x0d2c),
            ...
            .Init(0x0d26, Behaves("Nut",
                new RunBehaviors(
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Ring of the Sphinx"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(goodloot, (ILoot)new TierLoot(11, ItemType.Weapon)),
                            Tuple.Create(goodloot, (ILoot)new TierLoot(10, ItemType.Weapon)),
                ...
                new RunBehaviors(
                    ...
                    HpLesserPercent.Instance(0.1f, /*If Hp is less than 10%, activate behaviors (rage)*/
                        new RunBehaviors(
                            ...
                            True.Instance(Once.Instance(SpawnMinionImmediate.Instance(0x0d1f, 1, 1, 4))),
                            //Artifact 1 (Circles Geb)
                            True.Instance(Once.Instance(SpawnMinionImmediate.Instance(0x0d20, 1, 1, 4))),
                            //Artifact 2 (Circles Bes and Nut)
                            True.Instance(Once.Instance(SpawnMinionImmediate.Instance(0x0d21, 1, 1, 4))),
                            //Artifact 3 (chases)
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Ring of the Nile"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Shendyt of Geb")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Scepter of Geb")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Book of Geb")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Geb's Ring of Wisdom"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(goodloot, (ILoot)new TierLoot(11, ItemType.Weapon)),
                            Tuple.Create(goodloot, (ILoot)new TierLoot(10, ItemType.Weapon)),
