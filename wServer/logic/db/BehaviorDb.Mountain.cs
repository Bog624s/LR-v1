...
namespace wServer.logic
{
    ...
    {
       // private const double PotProbability = 0.01575;

        private static readonly LootDef CommonGodSoulBag =
            new LootDef(0, 2, 0, 8,
                Tuple.Create(WBChance / 1000, (ILoot)new ItemLoot("Cap of Oasis")),
                Tuple.Create(WBChance / 1500, (ILoot)new ItemLoot("Spirit Catcher")),
                Tuple.Create(WBChance / 5000, (ILoot)new ItemLoot("Ashes of Phoenix")),
                Tuple.Create(0.020, (ILoot) new TierLoot(6, ItemType.Weapon)),
                Tuple.Create(0.015, (ILoot) new TierLoot(7, ItemType.Weapon)),
                Tuple.Create(0.010, (ILoot) new TierLoot(8, ItemType.Weapon)),
                Tuple.Create(WBChance / 2 , (ILoot) new TierLoot(9, ItemType.Weapon)),
                Tuple.Create(0.020, (ILoot) new TierLoot(7, ItemType.Armor)),
                Tuple.Create(0.015, (ILoot) new TierLoot(8, ItemType.Armor)),
                Tuple.Create(0.010, (ILoot) new TierLoot(9, ItemType.Armor)),
                Tuple.Create(WBChance / 2, (ILoot) new TierLoot(10, ItemType.Armor)),
                Tuple.Create(0.015, (ILoot) new TierLoot(3, ItemType.Ring)),
                Tuple.Create(0.001, (ILoot) new TierLoot(4, ItemType.Ring)),
                Tuple.Create(WBChance / 2, (ILoot) new TierLoot(5, ItemType.Ring)),
                Tuple.Create(0.030, (ILoot) new TierLoot(4, ItemType.Ability)),
                Tuple.Create(WBChance / 2, (ILoot) new TierLoot(5, ItemType.Ability))
                );

        private static _ Mountain = Behav()
            ...
            .Init(0x195e, Behaves("Native White Demon",
                IfNot.Instance(
                    Chasing.Instance(6, 9, 4, null),
                    SimpleWandering.Instance(4)
                    ),
            ...
            .Init(0x7011, Behaves("Native Ent God",
                IfNot.Instance(
                    Chasing.Instance(10, 7, 4, null),
                    SimpleWandering.Instance(4)
                    ),
                ...
                new QueuedBehavior(
                    Timed.Instance(1500,
                        False.Instance(Cooldown.Instance(300,
                            new RunBehaviors(
                                MultiAttack.Instance(15, 10*(float) Math.PI/180, 3, 0*(float) Math.PI/180,
                                    projectileIndex: 0),
                                MultiAttack.Instance(15, 10*(float) Math.PI/180, 3, 120*(float) Math.PI/180,
                                    projectileIndex: 0),
                                MultiAttack.Instance(15, 10*(float) Math.PI/180, 3, 240*(float) Math.PI/180,
                                    projectileIndex: 0)
                                )
                            ))
                        ),
                    Timed.Instance(1500,
                        False.Instance(Cooldown.Instance(300,
                            new RunBehaviors(
                                MultiAttack.Instance(15, 10*(float) Math.PI/180, 4, 60*(float) Math.PI/180,
                                    projectileIndex: 0),
                                MultiAttack.Instance(15, 10*(float) Math.PI/180, 4, 180*(float) Math.PI/180,
                                    projectileIndex: 0),
                                MultiAttack.Instance(15, 10*(float) Math.PI/180, 4, 300*(float) Math.PI/180,
                                    projectileIndex: 0)
                                )
                            ))
                        ),
                    Timed.Instance(1500,
                        False.Instance(Cooldown.Instance(300,
                            PredictiveMultiAttack.Instance(15, 15*(float) Math.PI/180, 2, 1, 1)
                            ))
                        )
                    ),
                condBehaviors: new ConditionalBehavior[]
            ...
            .Init(0x2005, Behaves("Test Pet",
                ThrowAttack.Instance(10, 10, 10, 180*(float) Math.PI/180)
                )
            )
            ;
    }
