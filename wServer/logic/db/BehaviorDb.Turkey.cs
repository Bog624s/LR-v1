        ...
        #region Loot
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 5, 0, 8,
                            Tuple.Create(0.017, (ILoot)new TierLoot(6, ItemType.Ability)),
                            Tuple.Create(0.017, (ILoot)new TierLoot(13, ItemType.Armor)),
                            Tuple.Create(0.017, (ILoot)new TierLoot(12, ItemType.Weapon)),
                            Tuple.Create(0.02, (ILoot)new TierLoot(5, ItemType.Ring)),
                            Tuple.Create(WBChance/10, (ILoot)new ItemLoot("America Sword")),
                            Tuple.Create(WBChance/10, (ILoot)new ItemLoot("America Armor")),
                            Tuple.Create(WBChance/10, (ILoot)new ItemLoot("America Shield")),
                            Tuple.Create(WBChance/10, (ILoot)new ItemLoot("America Ring")),
                            Tuple.Create(WBChance/20, (ILoot)new ItemLoot("Turkey Leg of Doom")),
