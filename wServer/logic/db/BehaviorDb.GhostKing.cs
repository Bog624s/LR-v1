...
namespace wServer.logic
{
    ...
    {
        private static _ GhostKing = Behav()
            ...
            .Init(0x092d, Behaves("Actual Ghost King",
                IfExist.Instance(-1,
                    ...
                    new RunBehaviors(
                        ...
                        If.Instance(EntityLesserThan.Instance(20, 1, 0x0929),
                            new RunBehaviors(
                                Rand.Instance(
                                    new RunBehaviors(
                                        new SimpleTaunt(
                            ...
                            Timed.Instance(5000, False.Instance(
                                new RunBehaviors(
                                    Cooldown.Instance(1000,
                                        new RandomTaunt(0.01, "I come back more powerful than you could ever imagine")),
                    ...
                    new QueuedBehavior(
                        ...
                        False.Instance(new QueuedBehavior(
                            ...
                            Timed.Instance(5000, False.Instance(
                                new RunBehaviors(
                                    Cooldown.Instance(1000,
                                        new RandomTaunt(0.01, "Only the Secret Ghost Master can kill the King")),
                            ...
                            new QueuedBehavior(
                                ...
                                Timed.Instance(5000,
                                    False.Instance(Cooldown.Instance(250,
                                        RingAttack.Instance(4, offset: 45*(float) Math.PI/180))))
                                )
                            ),
                        IfEqual.Instance(-1, 1,
                            ...
                            new QueuedBehavior( //Death
                                ...
                                OrderEntity.Instance(100, 0x092d,
                                    new RunBehaviors(
                                        Rand.Instance(
                                            new RunBehaviors(
                                                new SimpleTaunt(
