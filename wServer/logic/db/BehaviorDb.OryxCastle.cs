    ...
    private static _ Castle = Behav() 
        .Init(0x0d78, Behaves("Oryx Stone Guardian Right", 
          ...
          loot: new LootBehavior(LootDef.Empty,
            Tuple.Create(100, new LootDef(0, 8, 0, 9,
              Tuple.Create(0.01, (ILoot)new ItemLoot("Void Incantation")),
              Tuple.Create(0.75, (ILoot)new StatPotionLoot(StatPotion.Def)),
              Tuple.Create(blackbag, (ILoot)new ItemLoot("Ancient Vanguard Stone Sword")),
              Tuple.Create(whitebag, (ILoot)new ItemLoot("Ancient Stone Sword")),
              Tuple.Create(whitebag, (ILoot)new ItemLoot("Wine Cellar Incantation")),
                Tuple.Create(0.11, (ILoot)new ItemLoot("Small Chainmail Cloth")),
                Tuple.Create(0.08, (ILoot)new ItemLoot("Large Chainmail Cloth")),
        ...
        .Init(0x0d82, Behaves("Oryx Brute",
            new RunBehaviors(
                ...
                Cooldown.Instance(24000, If.Instance(IsEntityPresent.Instance(10, null), SpawnMinionImmediate.Instance(0x0d81, 1, 1, 2)))
                ),
            loot: new LootBehavior(LootDef.Empty,
            ...
            new RunBehaviors(
              ...
              IfEqual.Instance(-1, 2,
                new RunBehaviors(
                  ...
                  Cooldown.Instance(999, Heal.Instance(0.1f, 299, 0x0d7e)),
        ...
        .Init(0x0d7f, Behaves("Oryx Insect Commander",
            new RunBehaviors(
                ...
                If.Instance(EntityLesserThan.Instance(10, 3, 0x0d80), SpawnMinionImmediate.Instance(0x0d80, 5, 1, 3))
                ),
            loot: new LootBehavior(LootDef.Empty,
                Tuple.Create(100, new LootDef(0, 5, 0, 2,
