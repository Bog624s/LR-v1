    ...
    partial class BehaviorDb
    {
        private static _ Sanctuary = Behav()
            ...
            .Init(0x700d, Behaves("Elder Tree",
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.45, (ILoot)new ItemLoot("Ent's Branch"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(WBChance / 8, (ILoot)new TierLoot(10, ItemType.Armor)),
                            Tuple.Create(WBChance / 4, (ILoot)new TierLoot(9, ItemType.Armor)),
                            Tuple.Create(WBChance, (ILoot)new TierLoot(8, ItemType.Weapon)),
                            Tuple.Create(WBChance * 1.25, (ILoot)new TierLoot(7, ItemType.Weapon)),
                            Tuple.Create(WBChance * 1.75, (ILoot)new TierLoot(6, ItemType.Weapon))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(WBChance / 8, (ILoot)new TierLoot(9, ItemType.Weapon)),
                            Tuple.Create(WBChance / 4, (ILoot)new TierLoot(8, ItemType.Weapon)),
                            Tuple.Create(WBChance, (ILoot)new TierLoot(7, ItemType.Armor)),
                            Tuple.Create(WBChance * 1.25, (ILoot)new TierLoot(6, ItemType.Armor)),
                            Tuple.Create(WBChance * 1.75, (ILoot)new TierLoot(5, ItemType.Armor))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(WBChance / 4, (ILoot)new TierLoot(5, ItemType.Ring)),
                            Tuple.Create(WBChance / 2, (ILoot)new TierLoot(4, ItemType.Ring)),
                            Tuple.Create(WBChance, (ILoot)new TierLoot(3, ItemType.Ring)),
                            Tuple.Create(WBChance * 2, (ILoot)new TierLoot(2, ItemType.Ring)),
                            Tuple.Create(WBChance * 4, (ILoot)new TierLoot(1, ItemType.Ring))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(WBChance / 8, (ILoot)new TierLoot(5, ItemType.Ability)),
                            Tuple.Create(WBChance / 4, (ILoot)new TierLoot(4, ItemType.Ability)),
                            Tuple.Create(WBChance / 2, (ILoot)new TierLoot(3, ItemType.Ability)),
                            Tuple.Create(WBChance, (ILoot)new TierLoot(2, ItemType.Ability)),
                            Tuple.Create(WBChance * 2, (ILoot)new TierLoot(1, ItemType.Ability))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
            ...
            .Init(0x2f14, Behaves("Wisp Queen",
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(WBChance, (ILoot)new ItemLoot("Potion of Mana"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(WBChance / 8, (ILoot)new TierLoot(10, ItemType.Weapon)),
                            Tuple.Create(WBChance / 4, (ILoot)new TierLoot(9, ItemType.Weapon)),
                            Tuple.Create(WBChance, (ILoot)new TierLoot(8, ItemType.Weapon)),
                            Tuple.Create(WBChance * 1.25, (ILoot)new TierLoot(7, ItemType.Weapon)),
                            Tuple.Create(WBChance * 1.75, (ILoot)new TierLoot(6, ItemType.Weapon))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(WBChance / 8, (ILoot)new TierLoot(11, ItemType.Armor)),
                            Tuple.Create(WBChance / 4, (ILoot)new TierLoot(10, ItemType.Armor)),
                            Tuple.Create(WBChance, (ILoot)new TierLoot(9, ItemType.Armor)),
                            Tuple.Create(WBChance * 1.25, (ILoot)new TierLoot(8, ItemType.Armor)),
                            Tuple.Create(WBChance * 1.75, (ILoot)new TierLoot(7, ItemType.Armor))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(WBChance / 4, (ILoot)new TierLoot(5, ItemType.Ring)),
                            Tuple.Create(WBChance / 2, (ILoot)new TierLoot(4, ItemType.Ring)),
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.11, (ILoot)new ItemLoot("Small Purple Bones Cloth")),
                            Tuple.Create(0.08, (ILoot)new ItemLoot("Large Purple Bones Cloth"))
                    ))
                    )
                ));
    }
