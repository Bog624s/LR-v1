    ...
    partial class BehaviorDb
    {
        private static _ Abyss = Behav()
            .Init(0x090a, Behaves("Archdemon Malphas",
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 2, 0, 8,
                            Tuple.Create(0.85, (ILoot)new ItemLoot("Potion of Vitality")),
                            Tuple.Create(0.35, (ILoot)new ItemLoot("Potion of Defense"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(blackbag, (ILoot)new ItemLoot("Arch-demon Blade")),
                            Tuple.Create(whitebag / 2, (ILoot)new ItemLoot("Sword of Illumination")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Demon Blade"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(whitebag / 4, (ILoot)new ItemLoot("Void Incantation")),
                            Tuple.Create(whitebag / 2, (ILoot)new ItemLoot("Wine Cellar Incantation"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.11, (ILoot)new ItemLoot("Small Skull Cloth")),
                            Tuple.Create(0.08, (ILoot)new ItemLoot("Large Skull Cloth"))
                    ))
                   )
                ))
            ...
            .Init(0x0e1d, Behaves("Abyss Idol",
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 2, 0, 8,
                            Tuple.Create(0.35, (ILoot)new ItemLoot("Potion of Vitality")),
