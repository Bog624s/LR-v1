...
namespace wServer.logic
{
    ...
    {
        private static _ EntAncient = Behav()
                ...
                If.Instance(
                    ...
                    Reproduce.Instance(0x0922, 3, 3000, 1)
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Ent's Branch"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            ...
                            Tuple.Create(poorloot, (ILoot)new TierLoot(5, ItemType.Weapon)),
                            Tuple.Create(poorloot, (ILoot)new TierLoot(4, ItemType.Weapon))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            ...
                            Tuple.Create(poorloot, (ILoot)new TierLoot(6, ItemType.Armor)),
                            Tuple.Create(poorloot, (ILoot)new TierLoot(5, ItemType.Armor))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
            ...
            .Init(0x0923, Behaves("Greater Nature Sprite",
                ...
                new RunBehaviors(
                    ...
                    If.Instance(IsEntityNotPresent.Instance(35, 0x0920), new Transmute(0x0924)),
                    new QueuedBehavior(
                        CooldownExact.Instance(90000),
                        Despawn.Instance
                        ),
            ...
            .Init(0x0924, Behaves("Actual Greater Nature Sprite",
                If.Instance(
                    WithinSpawn.Instance(11),
                    Circling.Instance(4, 10, 20, null),
                    ReturnSpawn.Instance(15)
                    ),
                new RunBehaviors(
                    Flashing.Instance(1000, 0xff000000),
                    Cooldown.Instance(2000, HealGroup.Instance(20, 800, "Heros")),
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.45, (ILoot)new ItemLoot("Potion of Attack"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(blackbag, (ILoot)new ItemLoot("Quiver of Thunderstorm")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Quiver of Thunder"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.11, (ILoot)new ItemLoot("Green Drake Egg")),
                            Tuple.Create(0.08, (ILoot)new ItemLoot("White Drake Egg"))
                    ))
                )
               )
            )
