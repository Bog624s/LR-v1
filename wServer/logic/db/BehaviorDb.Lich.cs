            ...
            .Init(0x091c, Behaves("Actual Lich",
                ...
                new QueuedBehavior(
                    ...
                    Rand.Instance(
                        ...
                        new LootDef(0, 4, 0, 8,
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Lich Crown")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Giant Snake Egg")),
                ...
                new RunBehaviors(
                    ...
                    Cooldown.Instance(500,
                        Rand.Instance(
                            ...
                            PredictiveAttack.Instance(10, 1, 1)
                            )
                        )
                    ),
                /*
                
                Soul of the Bearer ok!
                Ring of the Covetous Heart ok!
                
                */
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("The Phylactery")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Soulless Robe")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Soul of the Bearer")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Ring of the Covetous Heart"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(25 * WBChance / 2, (ILoot)new ItemLoot("White Drake Egg")),
                            Tuple.Create(25 * WBChance, (ILoot)new ItemLoot("Orange Drake Egg"))
                    ))
                    )
                ))
