                ...
                new RunBehaviors(
                  ...
                  loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 5, 0, 15,
                            Tuple.Create(WBChance/5, (ILoot)new ItemLoot("Christmas Blade")),
                            Tuple.Create(WBChance/5, (ILoot)new ItemLoot("Tree Topper Star")),
                            Tuple.Create(WBChance/5, (ILoot)new ItemLoot("Reindeer Skin Armor")),
                            Tuple.Create(WBChance/5, (ILoot)new ItemLoot("Santa Hat")),
                            Tuple.Create(WBChance/5, (ILoot)new ItemLoot("Christmas Miracle")),
                            Tuple.Create(0.017, (ILoot)new TierLoot(5, ItemType.Ability)),
                            Tuple.Create(0.015, (ILoot)new TierLoot(6, ItemType.Ability)),
                            Tuple.Create(0.017, (ILoot)new TierLoot(11, ItemType.Armor)),
                            Tuple.Create(0.016, (ILoot)new TierLoot(12, ItemType.Armor)),
                            Tuple.Create(0.015, (ILoot)new TierLoot(13, ItemType.Armor)),
                            Tuple.Create(0.017, (ILoot)new TierLoot(10, ItemType.Weapon)),
                            Tuple.Create(0.016, (ILoot)new TierLoot(11, ItemType.Weapon)),
                            Tuple.Create(0.015, (ILoot)new TierLoot(12, ItemType.Weapon)),
                            Tuple.Create(0.015, (ILoot)new TierLoot(5, ItemType.Ring)),
                            Tuple.Create(0.04, (ILoot)new StatPotionLoot(StatPotion.Att)),
                            Tuple.Create(0.04, (ILoot)new StatPotionLoot(StatPotion.Wis)),
                            Tuple.Create(0.04, (ILoot)new StatPotionLoot(StatPotion.Vit)),
                            Tuple.Create(0.04, (ILoot)new StatPotionLoot(StatPotion.Spd))
                            )),
                        Tuple.Create(100, new LootDef(0, 5, 0, 15,
