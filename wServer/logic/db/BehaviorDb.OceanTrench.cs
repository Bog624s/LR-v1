    ...
    partial class BehaviorDb
    {
        private static _ Trench = Behav()
            .Init(0x1706, Behaves("Thessal the Mermaid Goddess",
                ...
                {
                    new OnDeath(
                        Once.Instance(new RandomDo(35, SpawnMinionImmediate.Instance(0x1704, 1, 1, 1))))
                },
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 2, 0, 8,
                            Tuple.Create(0.45, (ILoot)new ItemLoot("Potion of Mana")),
                            Tuple.Create(0.5, (ILoot) new ItemLoot("Coral Juice"))
                    )),
                        Tuple.Create(100, new LootDef(0, 2, 0, 8,
                            Tuple.Create(blackbag, (ILoot)new ItemLoot("Red Coral Ring")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Coral Ring")),
                            Tuple.Create(blackbag, (ILoot)new ItemLoot("Red Coral Bow")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Coral Bow")),
                            Tuple.Create(blackbag, (ILoot)new ItemLoot("Red Coral Venom Trap")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Coral Venom Trap")),
                            Tuple.Create(blackbag, (ILoot)new ItemLoot("Red Coral Silk Armor")),
                            Tuple.Create(awesomeloot, (ILoot)new ItemLoot("Coral Silk Armor"))
                    )),
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.11, (ILoot)new ItemLoot("Small Pink Maze Cloth")),
                            Tuple.Create(0.08, (ILoot)new ItemLoot("Large Pink Maze Cloth"))
                    ))
                    )
                ))
