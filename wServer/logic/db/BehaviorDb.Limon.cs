            ...
            .Init(0x0d06, Behaves("Limon the Sprite God",
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 2, 0, 8,
                            Tuple.Create(0.85, (ILoot)new ItemLoot("Potion of Dexterity")),
                            Tuple.Create(0.15, (ILoot)new ItemLoot("Potion of Defense"))
                    )),
                        Tuple.Create(100, new LootDef(0, 2, 0, 8,
                            Tuple.Create(blackbag, (ILoot)new ItemLoot("Staff of Endless Prejudice")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Cloak of the Planewalker")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Staff of Extreme Prejudice")),
                            Tuple.Create(awesomeloot, (ILoot)new ItemLoot("Sprite Wand"))
                    )),
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.11, (ILoot)new ItemLoot("Small Rainbow Cloth")),
                            Tuple.Create(0.08, (ILoot)new ItemLoot("Large Rainbow Cloth"))
                    ))
                    )))
