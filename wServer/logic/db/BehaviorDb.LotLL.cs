                ...
                Behaves("Lord of the Lost Lands",
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Lord's Heavyarmor Piece"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(blackbag, (ILoot)new ItemLoot("Ancient Sapphire Shield of Ogmur")),
                            Tuple.Create(whitebag, (ILoot)new ItemLoot("Shield of Ogmur"))
                    )),
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
