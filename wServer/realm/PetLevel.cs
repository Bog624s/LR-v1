...
namespace wServer.realm
{
    ...
    public class PetLevel
    {
        ...
        public PetLevel(AbilityType ability, Ability abilityType, int power, int level, NewPet pet)
        {
            this.pet = pet;
            type = ability;
            Ability = abilityType;
        ...
        public void Incease(IFeedable petFoodNOMNOMNOM)
        {
            ...
            if (type == AbilityType.Second)
                remaining = (int)(petFoodNOMNOMNOM.FeedPower * 0.33333);
            if (type == AbilityType.Third)
                remaining = (int)(petFoodNOMNOMNOM.FeedPower * 0.14285);
