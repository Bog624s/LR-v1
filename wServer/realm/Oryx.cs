...
namespace wServer.realm
{
    ...
    internal class Oryx
    {
        ...
        private const double realmevent = 0.75;
        ...
        private readonly List<Tuple<string, ISetPiece>> events = new List<Tuple<string, ISetPiece>>
        {
            ...
            //Tuple.Create("Tomb Defender", (ISetPiece) new Tomb()),
            //Tuple.Create("The Forgotten King", (ISetPiece) new King()),
            //Tuple.Create("Bridge Sentinel", (ISetPiece) new Sentinel()),
            Tuple.Create("Lord Ruthven", (ISetPiece) new Ruthven()),
            Tuple.Create("Avatar of the Forgotten King", (ISetPiece) new Avatar()),
            Tuple.Create("Eye of the Rock Dragon", (ISetPiece) new EyRockDragon()),
            Tuple.Create("Maurth the Succubus Queen", (ISetPiece) new Succubus()),
            Tuple.Create("Undertaker the Great Juggernaut", (ISetPiece) new Undertaker()),
            Tuple.Create("Oryx the Mad God 4", (ISetPiece) new OryxFour()),
            Tuple.Create("Oryx the Mad God 5", (ISetPiece) new OryxFive()),
            Tuple.Create("Oryx the Mad God 6", (ISetPiece) new OryxSix()),
            Tuple.Create("Oryx the Mad God 7", (ISetPiece) new OryxSeven()),
            Tuple.Create("McFarvo the Fire God", (ISetPiece) new FireGod()),
            Tuple.Create("Mario Bros", (ISetPiece) new Mario())
            //Tuple.Create("Oryx Stone Guardian Right", (ISetPiece) new Guardians()) //both guardians
        };

        private readonly Random rand = new Random();
        public bool ClosingStartedF = false;
        public bool ClosingStartedS = false;
        public bool ClosingStartedT = false;
        public bool RealmClosed = false;
        public bool RealmClosedTwo = false;
            ...
            {
                {
                    WmapTerrain.ShoreSand, Tuple.Create(
                        1000, new[]
                        {
                            Tuple.Create("Pirate", 0.02),
                            //Tuple.Create("Piratess", 0.1),
                            Tuple.Create("Snake", 0.02),
                            Tuple.Create("Scorpion Queen", 0.03)
                        })
                },
                {
                ...
                },
                {
                    WmapTerrain.Mountains, Tuple.Create(
                        ...
                        //was 550
                        {
                            Tuple.Create("White Demon", 0.016),
                            Tuple.Create("Mysterious Crystal", 0.00005),
                            Tuple.Create("Sprite God", 0.014),
                            Tuple.Create("Medusa", 0.014),
                            Tuple.Create("Ent God", 0.012),
                            Tuple.Create("Beholder", 0.017),
                            Tuple.Create("Flying Brain", 0.023),
                            Tuple.Create("Slime God", 0.015),
                            Tuple.Create("Ghost God", 0.015),
                            Tuple.Create("Rock Bot", 0.005),
                            Tuple.Create("Djinn", 0.013),
                            Tuple.Create("Leviathan", 0.013),
                            Tuple.Create("Dankins the Boshy Guy", 0.00005)
                        })
                }/*,
                {
                    WmapTerrain.BeachTowels, Tuple.Create(
                        1, new[]
                        {
                           Tuple.Create("Oryx the Mad God 2", 0.00000001)
        ...
        public bool CheckFinalQuests()
        {
            if (CountEnemies(
                ...
                "Grand Sphinx",
                "Pentaract",
                "Maurth the Succubus Queen",
                "Untertaker the Great Juggernaut") == 0)
            {
                RealmClosed = true;
                return true;
            }
        ...
        public bool CheckFinalQuestsThirdTime()
        {
            if (CountEnemies(
                "Lich",
                "Actual Lich") == 0)
        ...
        public bool CheckFinalQuestsSecondTime()
        {
            if (CountEnemies(
                "Ent Ancient",
                "Actual Ent Ancient",
        ...
        public void InitCloseRealmF()
        {
            ClosingStartedF = true;
        ...
        public void InitCloseRealmS()
        {
            ClosingStartedS = true;
            foreach (var i in world.Players.Values)
            {
                SendMsg(i, "I HAVE CLOSED LOE REALM IN 1 MINUTE!", "#Oryx the Mad God");
                SendMsg(i, "TIME TO FINAL BATTLE...", "#Oryx the Mad God");
        ...
        {
            SendMsg(player, "Welcome to LoE Realm!");
        ...
        private static readonly Tuple<string, TauntData>[] criticalEnemies =
        {
            ...
            Tuple.Create("Black Dragon God", new TauntData
            {
                numberOfEnemies = new[]
                {
                    "No one can beat 4th draconis!!!"
                },
                final = new[]
                {
                    "Noo! It's cannot be! Your soul would be mine..."
                }
            }),
            Tuple.Create("Oryx Stone Guardian Right", new TauntData
            {
                numberOfEnemies = new[]
                {
                    "I am invincible while my Stone Guardians still stand!"
                },
                final = new[]
                {
                    "Noo! It's cannot be! {PLAYER}, I will get your soul!"
                }
            }),
            ...
            Tuple.Create("Oryx the Mad God 1", new TauntData
            {
                numberOfEnemies = new[]
                {
                    "I'm coming to this realm to defeat you fools!"
                },
                final = new[]
                {
                    "Noooooooo! It's cannot be! {PLAYER}, you are in my list!"
                }
            }),
            ...
            Tuple.Create("Undertaker the Great Juggernaut", new TauntData
            {
                spawn = new[]
                {
                    "My Undertaker destroy your soul!"
                },
                killed = new[]
                {
                    "My Undertaker was more than you'll ever be, {PLAYER}. I will kill you myself!"
                }
            }),
