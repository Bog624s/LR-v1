...
namespace wServer.realm.entities.player
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
            ...
            : base((short) psr.Character.ObjectType, psr.Random)
        {
            ...
            /*if (psr.Account.Tag == "Owner" || psr.Account.Tag == "Mod")
            {
                Name = "(" + psr.Account.Tag + ") " + psr.Account.Name;
            }
            else if (psr.Account.Rank >= 11)
            {
                psr.Account.Tag = "Owner";
                //Name = "(" + psr.Account.Tag + ") " + psr.Account.Name;
            }
            else if (psr.Account.Rank == 4)
            {
                psr.Account.Tag = "Mod";
                //Name = "(" + psr.Account.Tag + ") " + psr.Account.Name;
            }*/
            ...
            //if (psr.Account.Rank >= 11) { /* || psr.Account.Name == "Luke" || psr.Account.Name == "Amaymon")*/
              //  SetSize.Instance(150);
            //}
            /*else if (psr.Account.Rank >= 3)
                Stars = 100;
            else if (psr.Account.Rank > 1)
                Stars = 95;
            else*/
            if(psr.Account.Rank >= 11)
            {
                Size = desc != null ? XmlDatas.ObjectDescs[ObjectType].MaxSize : 180;
                Stars = 200;
            }
            else if (psr.Account.Rank == 4)
                Stars = 150;
            ...
            ConditionEffects = 0;
            /*int HPBar = ((psr.Character.HitPoints/psr.Character.MaxHitPoints)*100);
            int ReveHP = 100 - HPBar;*/
            // OxygenBar = Stars;
            if((Stars >= 0) && (Stars <= 25)) {
                OxygenBar = 25;
            }
            ...
            //OxygenBar = 100;
            //int miHP = psr[StatsType.HP];
            //OxygenBar = ((stats[StatsType.HP])/psr.Character.MaxHitPoints)*100;
            //OxygenBar = (psr.Character.HitPoints/psr.Character.HitPoints)*100;
            //OxygenRegen = 1;
        ...
        public int CurrentCharSlot { get; set; }
        public int CurrentVIP { get; set; }
        public int CurrentPetGift { get; set; }
                    ...
                    else
                    {
                        switch (entity.ObjectType) //handling default case for not found. Add more as implemented
                        {
                            ...
                            case 0x0730:
                                ...
                                break;
                            case 0x7209:
                                world = RealmManager.AddWorld(new Tournament());
                                break;
                            case 0x070c:
                            ...
                            case 0x071a:
                                ...
                                break;
                            case 0x704c:
                                world = RealmManager.AddWorld(new Underground());
                                break;
                            case 0x7084:
                                world = RealmManager.AddWorld(new BGrotto());
                                break;
                            case 0x7236:
                                world = RealmManager.AddWorld(new Graw());
                                break;
                            case 0x7085:
                                world = RealmManager.AddWorld(new DDocks());
                                break;
                            case 0x1901:
                            ...
                            case 0x4a2a:
                                ...
                                break;
                            case 0x5050:
                                world = RealmManager.AddWorld(new Shats());
                                break;
                            case 0x2fbb:
            ...
            switch (killer)
            {
                ...
                case "Unknown":
                    Owner.BroadcastPacket(new TextPacket
                    {
                        ...
                        Stars = -1,
                        Name = "",
                        Text = Name + " died at Level " + Level + " with " + Fame + " fame base (" + Experience + " XP)."
                    }, null);
                    break;
                default:
                    Owner.BroadcastPacket(new TextPacket
                    {
                        ...
                        Stars = -1,
                        Name = "",
                        Text = Name + " died at Level " + Level + " with " + Fame + " fame base (" + Experience + " XP). Killed by " + killer + "."
                    }, null);
                    //Manager.Chat.Announce(Name + " has been killed by " + killer + ". Died in " + Owner.Name + " with level " + Level + " and " + Fame + " fame base (" + Experience + " XP).");
                    break;
                ...
                Owner.BroadcastPacket(new TextPacket
                {
                    ...
                    Stars = -1,
                    Name = "",
                    Text = "[" + Owner.Name + "] " + Name + " died at level " + Level + " with " + Fame + " fame base. Killed by " + killer
                }, null);
                Manager.Chat.RIP(Name + " has been killed by " + killer + ". Died in " + Owner.Name + " with level " + Level + " and " + Fame + " fame base.");
                */
