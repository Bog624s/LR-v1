...
{
    public class NewPet : Entity//, IPlayer
    {
        private Random rand;
        private Position? spawn;

        public NewPet(RealmManager manager, PetItem petData, Player playerOwner)
            : base(manager, (short)petData.Type, true, true)
        {
            rand = new Random();
            ...
            try
            {
                if (petData.InstanceId != -1)
                {
                    ...
                    //Size = manager.GameData.TypeToPet[(short)petData.Type].Size;
                    Size = 100;
        ...
        public Player PlayerOwners { get; set; }
