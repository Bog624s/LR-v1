...
namespace wServer.realm.commands
{
        ...
        public void Execute(Player player, string[] args)
        {
            ...
            if (args.Length > 0 && int.TryParse(args[0], out num)) //multi
            {
                ...
                else
                {
                    ...
                    if (player.Client.Account.Rank < 10 && c > 1)
                    {
                        player.SendError("Maximum spawn count is set to 1!");
                        return;
                    }
    ...
    internal class ArenaCommand : ICommand
    {
        ...
        public void Execute(Player player, string[] args)
        {
            ...
            w.Timers.Add(new WorldTimer(210*1000, (world, t) => //default portal close time * 1000
            ...
            foreach (var i in RealmManager.Clients.Values)
                i.SendPacket(new TextPacket
                {
                    ...
                    Stars = -1,
                    Name = "",
                    Text = "LoE Arena Opened by " + player.nName + "!"
                });
            foreach (var i in RealmManager.Clients.Values)
                i.SendPacket(new NotificationPacket
                {
                    ...
                    ObjectId = player.Id,
                    Text = "The LoE Arena opened by team member " + player.nName + "."
                });
        }
    }
        ...
        public void Execute(Player player, string[] args)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        player.SendInfo("Player has been disconnected by you.");
                        target.Client.Disconnect();
                    }
                }
                catch
                {
                    player.SendError("Cannot kick! Hmmm...");
                }
            }
        }
    }
    ...
    internal class SWhoCommand : ICommand //get all players from all worlds (this may become too large!)
    {
        ...
        public void Execute(Player player, string[] args)
        {
            var sb = new StringBuilder("List of all players: ");
            var players = 0;
	...
	internal class AllSummon : ICommand
    {
        public string Command
        {
            get { return "allsummon"; }
        }
        ...
        public void Execute(Player player, string[] args)
        {
            foreach (var i in RealmManager.Clients.Values)
                ...
                {
                    Title = "Teleport!",
                    Message = "You going to teleport to " + player.Owner.Name + ". Just wait 5 seconds to get it.",
                    Button1 = "Alright!",
                    Type = "GlobalMsg"
                });
            Thread.Sleep(5000);
            ...
            player.SendInfo("All players of LoE Realm connecting in this world...");
        }
    }
                ...
                foreach (var w in RealmManager.Worlds)
                {
                    ...
                    if (w.Key != 0)
                    {
                        world.BroadcastPacket(new TextPacket
                        {
                            ...
                            BubbleTime = 0,
                            Text =
                                "Loe Team advertsing: Server restarting soon. Please be ready to disconnect."
                        }, null);
                    }
                }
            }
    ...
    internal class BanC : ICommand
    {
        ...
        public void Execute(Player player, string[] args)
        {
            ...
            player.Client.SendPacket(new TextBoxPacket()
            {
                Title = "Confirm Banishment",
                Message = "Do you really ban " + name + "?",
                Button1 = "Confirm",
                Button2 = "Cancel",
            ...
            else
            {
                try
                {
                    using (var dbx = new Database())
                    {
                        ...
                        if (cmd.ExecuteNonQuery() == 0)
                        {
                            player.SendInfo("Couldn't ban player!");
                        }
                        else
                        {
                            ...
                            player.SendInfo("Terminating... GG");
                        }
                        dbx.Dispose();
                    }
                }
    ...
    internal class UnBan : ICommand
    {
        ...
        public void Execute(Player player, string[] args)
        {
            ...
            {
                player.SendInfo("Could not unban, please don't unban. Forgive this player.");
            }
        }
    }
    ...
    internal class GodMode : ICommand
    {
        ...
        public void Execute(Player player, string[] args)
        {
            if (player.HasConditionEffect(ConditionEffects.Invincible))
            {
                ...
                player.SendInfo("LoE Protection Inactivated!");
            }
            else
            {
                player.ApplyConditionEffect(new ConditionEffect
                ...
                player.SendInfo("LoE Protection Activated");
                foreach (var i in RealmManager.Clients.Values)
                    i.SendPacket(new NotificationPacket
                    {
                        Color = new ARGB(0xff00ff00),
                        ObjectId = player.Id,
                        Text = "LoE Protection Activated!"
                    });
            }
        }
    }
    ...
    internal class CurrencyCommand : ICommand
    {
        ...
        public void Execute(Player player, string[] args)
        {
            try
            {
                if (args.Length < 2)
                {
                    player.SendHelp("Use /cred <currency> <player> <amount>");
                }
    ...
    internal class CloseRealmCommandF : ICommand
    {
        public string Command
        {
            get { return "closerealmf"; }
        }
        ...
        public void Execute(Player player, string[] args)
        {
            ...
            {
                var gw = player.Owner as GameWorld;
                gw.Overseer.InitCloseRealmF();
            }
        }
    }
	
    internal class CloseRealmCommandS : ICommand
    {
        public string Command
        {
            get { return "closerealms"; }
        }
        ...
        public void Execute(Player player, string[] args)
        {
            ...
            {
                var gw = player.Owner as GameWorld;
                gw.Overseer.InitCloseRealmS();
            }
        }
    }
	
    internal class CloseRealmCommandT : ICommand
    {
        public string Command
        {
            get { return "closerealmt"; }
        }
	...
	internal class SetTag : ICommand
    {
        ...
        public void Execute(Player player, string[] args)
        {
            if (args.Length < 1)
            {
                player.SendHelp("Usage: /settag <player> <tag>");
            }
            else
            {
                if (args.Length == 1)
    ...
    internal class Vanish : ICommand
    {
        ...
        public void Execute(Player player, string[] args)
        {
            player.SendInfo("LoE Hide System: ON!");
    ...
    internal class Unvanish : ICommand
    {
        ...
        public void Execute(Player player, string[] args)
        {
            player.SendInfo("LoE Hide System: OFF!");
    ...
    class Spectate : ICommand
    {
        ...
        public int RequiredRank { get { return 11; } }
