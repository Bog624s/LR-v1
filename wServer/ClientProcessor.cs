...
namespace wServer
{
    ...
    public class ClientProcessor
    {
        ...
        public string clientVer = "ChicagoServer_v30.0.01"; //actual version of loe realm client
        private Database db;
            ...
            try
            {
                ...
                //Network protocols optimization...
                   ...
                   // entity.InventoryDrop(realtime, pkt as InvDropPacket);
                    ...
                    //entity.Teleport(realtime, pkt as TeleportPacket);
                    ...
                    entity.GroundDamage(realtime, pkt as GroundDamagePacket);
                    ...
                    entity.VisibulletHit(pkt as VisibulletPacket);
        ...
        private void ProcessHelloPacket(HelloPacket pkt)
        {
            ...
            else
            {
                ...
                if (!ConnectedBuildStartsWith(clientVer))
                {
                    ...
                    {
                        Button1 = "Alright!",
                        Message = "Your client is outdated, Click <font style=\"color:white; text-shadow:1px 0px 1px #454545;\"><b><a href=\"http://loerealm.com/\">Here</a></b></font> to get it!",
                        Title = "version " + clientVer + " alive!",
                        Type = "NewClient"
                    });
                    Disconnect();
                }
                            ...
                            for (var i = 4; i < 12; i++)
                            {
                                if (chrEquip[i] == -1)
                                {
                                    ...
                                    SendPacket(new TextPacket
                                    {
                                        ...
                                        BubbleTime = 0,
                                        Stars = -1,
                                        Text = "<*LoE GIFT*> You received " + XmlDatas.TypeToId[chrEquip[i]] + "."
                                    });
                                    if (IP.Gifts.Count == 0)
                                        break;
                                }
