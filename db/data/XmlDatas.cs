...
namespace db.data
{
    public class XmlDatas
    {
        ...
        public static IDictionary<short, PetStruct> TypeToPet { get; private set; }
        //public static IDictionary<string, PetSkin> IdToPetSkin { get; private set; }
        public IDictionary<ushort, SkinDesc> Skins { get; private set; }
        public static IDictionary<short, SetTypeSkin> SetTypeSkins { get; private set; }
